...
## Download and install VirtualBox
 ...
 5. **After successfull creation select DebianTeroKarvinenCom and select settings**
     - Go to storage
   ...
   5. **Select Key Board**
   6. **Configure Network"**
   7. **Give Host Name: debian-vm**
   8. **Domain password: Blank**
   9. **Root password: Insert strong password**
   10. **User Account:Name,User Name and strong password**
   11. **Partitian Disks**
